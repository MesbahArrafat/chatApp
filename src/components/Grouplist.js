  ...
  return (
    ...
    h-[305px] overflow-scroll">
     ...
     <div className='flex gap-x-5 items-center border-b border-solid border-primary pb-3.5 mt-3.5'>
        <div>
            <img className='w-[70ox] h-[70px] rounded-full' src='images/grouplist.png'/>
        </div>
        <div>
        <h3 className="font-nunito font-bold text-xl">Friends Reunion</h3>
        <p className="font-nunito font-semibold text-[14px] text-[#4D4D4D]">Hi Guys, Wassup!</p>
        </div>
        <div>
            <button className='font-nunito font-bold text-xl bg-primary text-white py-2.5 px-5 rounded'>Join</button>
        </div>
     </div>
     <div className='flex gap-x-5 items-center border-b border-solid border-primary pb-3.5 mt-3.5'>
        <div>
